...
export const OrderSuspenseLoader = () => (
  <div className="flex-1 flex flex-col items-center justify-center p-12 w-full h-full min-h-[50vh]">
    <div className="preloader" style={{ maxWidth: '300px' }}>
      <div className="truck-loader-container mx-auto loader">
        <div className="truckWrapper">
          ...
          <div className="truckTires">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 30 30" className="tiresvg">
              ...
              <circle fill="#FFFFFF" r="7" cy="15" cx="15"></circle>
            </svg>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 30 30" className="tiresvg">
              <circle strokeWidth="3" stroke="#282828" fill="#282828" r="13.5" cy="15" cx="15"></circle>
              <circle fill="#FFFFFF" r="7" cy="15" cx="15"></circle>
          ...
          <svg xmlSpace="preserve" viewBox="0 0 453.459 453.459" xmlnsXlink="http://www.w3.org/1999/xlink" id="Capa_1" version="1.1" fill="#000000" className="lampPost">
            ...
            <path fill="#fabb18" d="M232.77,111.694c0,23.442-19.071,42.514-42.514,42.514c-23.442,0-42.514-19.072-42.514-42.514c0-5.531,1.078-10.957,3.141-16.017 h78.747C231.693,100.736,232.77,106.162,232.77,111.694z"></path>
          </svg>
        </div>
      </div>
      <div className="preloader__text mt-4">
        <p className="preloader__msg font-bold text-foreground">Getting things rolling…</p>
