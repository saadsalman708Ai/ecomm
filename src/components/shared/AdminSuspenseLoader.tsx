...
import { OrderSuspenseLoader } from './OrderSuspenseLoader';
...
export const AdminSuspenseLoader = () => {
  const [useCart] = useState(() => Math.random() < 0.5);
  return useCart ? <SuspenseLoader /> : <OrderSuspenseLoader />;
};
